...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if ($userId) {
		// Actualizar usuario
		$stmt = $conn->prepare('UPDATE users SET email = :email, nombre = :nombre, apellidos = :apellidos WHERE id_user = :id');
			...
			<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
				...
				<div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
					...
					<?php if (!empty($message)) : ?>
						...
						<!--end::Alert-->
					<?php endif; ?>
					<form action="session/registro.php" method="POST" class="form w-100 needs-validation">
						<!--begin::Heading-->
